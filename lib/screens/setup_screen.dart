          ...
          children: [
            ...
            if (isError) ...[
              Builder(builder: (bCtx) {
                ...
                final isArchError = errMsg.contains('Unsupported CPU') ||
                    errMsg.contains('x86') || errMsg.contains('ARM64');
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isArchError) ...[
                        const Row(children: [
                          Icon(Icons.computer, color: Color(0xFFE65100), size: 20),
                          SizedBox(width: 8),
                          Expanded(child: Text(
                            'Emulator / x86 CPU not supported',
                        ...
                        const Text(
                          'proot sirf real ARM64 Android phone pe chalta hai.\n\n'
                          'Firebase Studio emulator (x86_64) pe yeh kaam nahi karega.\n\n'
                          '✅ Real device pe build karo:\n'
                        ...
                        Text(
                          errMsg.isNotEmpty ? errMsg : 'Installation failed',
              ...
              const SizedBox(height: 16),
              if (!(provider.errorMessage ?? '').contains('Unsupported CPU') &&
                  !(provider.errorMessage ?? '').contains('ARM64'))
                FilledButton.icon(
                  onPressed: () {
                    provider.clearError();
